...
def train(train_dir, model_save_path=None, n_neighbors=None, knn_algo='ball_tree', verbose=False):
    ...
    train_dir = os.listdir('C:/Users/student/PycharmProjects/faceun/datasets/')
    print(train_dir)

    # Loop through each person in the training directory
    for person in train_dir:
        pix = os.listdir("C:/Users/student/PycharmProjects/faceun/datasets/" + person)

        # Loop through each training image for the current person
        for person_img in pix:
            # Get the face encodings for the face in each image file
            print("C:/Users/student/PycharmProjects/faceun/datasets/" + person + "/" + person_img)
            face = face_recognition.load_image_file("C:/Users/student/PycharmProjects/faceun/datasets/" + person + "/" + person_img)
            print(face.shape)
